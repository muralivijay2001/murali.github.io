...
const Experience = () => {
    return (
        <Grid container spacing={2} className="container" sx={{ padding: '100px', alignItems: 'center'}}>
            ...
            <Grid item xs={4} sm={4} md={4} lg={4}>
                <Box className="main-box box3">
                    <Box className="card3">
                        <Box className="card-main">
                            <Box className="logo">
                                <Box component="span" className="circle circle1" />
                                <Box component="span" className="circle circle2" />
                                <Box component="span" className="circle circle3" />
                                <Box component="span" className="circle circle4" />
                                <Box component="span" className="circle circle5">
                                    <Box component="svg" className="svg" viewBox="0 0 100 100" fill="white">
                                        <path
                            ...
                            <Box className="content">
                                <Box component="span" className="title">Web Developer</Box>
                                <Box component="span" className="text">2021-2022</Box>
                                <Box component="span" className="text">The best place to build, test, and discover front-end code.</Box>
                            </Box>
                            {/* <Box className="bottom" sx={{ marginTop: '10px'}}>
                                <Box className="social-buttons-container">
                                    <Button className="social-button .social-button1">
                                        <Box component="svg" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg" class="svg">
                                            <path
                                    ...
                                    <Button className="social-button .social-button2">
                                        <Box component="svg" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" class="svg">
                                            <path
                                    ...
                                    <Button className="social-button .social-button3">
                                        <Box component="svg" viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg" class="svg">
                                            <path
                                ...
                                <Box className="view-more">
                                    ...
                                    <Box component="svg" class="svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
